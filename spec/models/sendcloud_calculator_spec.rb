  ...
  describe Spree::Calculator::Shipping::Sendcloud::Base do
    ...
    describe "available" do
      context "when rates are available" do
        let(:rates) do
          [ double('rate', :service_name => 'PostNL Nederland', :service_code => "PostNL Nederland", :price => 1) ]
        end
    ...
    describe "compute" do
      let(:rates) do
        [ double('rate', :service_name => 'PostNL Nederland', :service_code => "PostNL Nederland", :price => 999) ]
      end
